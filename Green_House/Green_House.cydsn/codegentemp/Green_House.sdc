...
# Date: Mon, 06 Jun 2022 12:45:22 GMT
#set_units -time ns
...
create_generated_clock -name {timer_clock_1} -source [get_pins {ClockBlock/clk_sync}] -edges {1 4800001 9600001} [list [get_pins {ClockBlock/dclk_glb_4}]]
