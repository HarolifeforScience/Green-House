...
# Date: Thu, 26 May 2022 08:55:51 GMT
#set_units -time ns
create_clock -name {ADC_SOIL_MOISTURE_Ext_CP_Clk(routed)} -period 41.666666666666664 -waveform {0 20.8333333333333} [list [get_pins {ClockBlock/dclk_0}]]
...
create_clock -name {ADC_SOIL_MOISTURE_Ext_CP_Clk} -period 41.666666666666664 -waveform {0 20.8333333333333} [list [get_pins {ClockBlock/dclk_glb_0}]]
...
create_generated_clock -name {ADC_SOIL_MOISTURE_theACLK} -source [get_pins {ClockBlock/clk_sync}] -edges {1 105 209} -nominal_period 4333.333333333333 [list [get_pins {ClockBlock/aclk_glb_0}]]
create_generated_clock -name {timer_clock_1} -source [get_pins {ClockBlock/clk_sync}] -edges {1 2400001 4800001} [list [get_pins {ClockBlock/dclk_glb_4}]]
...
# Project: C:\Users\yamen\OneDrive\Dokumente\GitHub\Green-House\Green_House\Green_House.cydsn\Green_House.cyprj
# Date: Thu, 26 May 2022 08:55:43 GMT
