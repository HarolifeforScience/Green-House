...
module ADC_DelSig_v3_30_4 (
	...
	cy_clock_v1_0
		#(.id("9408daab-056a-48c3-92e2-449b47d56895/b7604721-db56-4477-98c2-8fae77869066"),
	...
	cy_clock_v1_0
		#(.id("9408daab-056a-48c3-92e2-449b47d56895/edd15f43-b66b-457b-be3a-5342345270c8"),
		  .source_clock_id("61737EF6-3B74-48f9-8B91-F7473A442AE7"),
		  .divisor(0),
...
module top ;
	...
	wire [0:0] tmpOE__I2C_RTC_SDA_net;
	wire [0:0] tmpFB_0__I2C_RTC_SDA_net;
	wire [0:0] tmpINTERRUPT_0__I2C_RTC_SDA_net;
	electrical [0:0] tmpSIOVREF__I2C_RTC_SDA_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("22863ebe-a37b-476f-b252-6e49a8c00b12"),
		  ...
		  .input_buffer_sel(2'b00))
		I2C_RTC_SDA
		 (.oe(tmpOE__I2C_RTC_SDA_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__I2C_RTC_SDA_net[0:0]}),
		  .io({Net_66}),
		  .siovref(tmpSIOVREF__I2C_RTC_SDA_net),
		  .interrupt({tmpINTERRUPT_0__I2C_RTC_SDA_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__I2C_RTC_SDA_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__I2C_RTC_SCL_net;
	wire [0:0] tmpFB_0__I2C_RTC_SCL_net;
	wire [0:0] tmpINTERRUPT_0__I2C_RTC_SCL_net;
	electrical [0:0] tmpSIOVREF__I2C_RTC_SCL_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("02f2cf2c-2c7a-49df-9246-7a3435c21be3"),
		  ...
		  .input_buffer_sel(2'b00))
		I2C_RTC_SCL
		 (.oe(tmpOE__I2C_RTC_SCL_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__I2C_RTC_SCL_net[0:0]}),
		  .io({Net_67}),
		  .siovref(tmpSIOVREF__I2C_RTC_SCL_net),
		  .interrupt({tmpINTERRUPT_0__I2C_RTC_SCL_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__I2C_RTC_SCL_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};


	cy_clock_v1_0
		#(.id("ec9dd4c5-b7af-456f-9dee-35431105a234"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("1000000000"),
		  .is_direct(0),
	...
	wire [0:0] tmpOE__LED_Heating_net;
	wire [0:0] tmpFB_0__LED_Heating_net;
	wire [0:0] tmpIO_0__LED_Heating_net;
	wire [0:0] tmpINTERRUPT_0__LED_Heating_net;
	electrical [0:0] tmpSIOVREF__LED_Heating_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e851a3b9-efb8-48be-bbb8-b303b216c393"),
		  ...
		  .input_buffer_sel(2'b00))
		LED_Heating
		 (.oe(tmpOE__LED_Heating_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__LED_Heating_net[0:0]}),
		  .io({tmpIO_0__LED_Heating_net[0:0]}),
		  .siovref(tmpSIOVREF__LED_Heating_net),
		  .interrupt({tmpINTERRUPT_0__LED_Heating_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__LED_Heating_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    ADC_DelSig_v3_30_4 ADC_SOIL_MOISTURE (
        .vplus(Net_144),
        .vminus(Net_145),
        .soc(1'b1),
        .eoc(Net_151),
	...
	wire [0:0] tmpOE__Soil_Moisture_Vin_Pin_net;
	wire [0:0] tmpFB_0__Soil_Moisture_Vin_Pin_net;
	wire [0:0] tmpIO_0__Soil_Moisture_Vin_Pin_net;
	wire [0:0] tmpINTERRUPT_0__Soil_Moisture_Vin_Pin_net;
	electrical [0:0] tmpSIOVREF__Soil_Moisture_Vin_Pin_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("8d318d8b-cf7b-4b6b-b02c-ab1c5c49d0ba"),
		  ...
		  .ovt_slew_control(2'b00),
		  .input_buffer_sel(2'b00))
		Soil_Moisture_Vin_Pin
		 (.oe(tmpOE__Soil_Moisture_Vin_Pin_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Soil_Moisture_Vin_Pin_net[0:0]}),
		  .analog({Net_144}),
		  .io({tmpIO_0__Soil_Moisture_Vin_Pin_net[0:0]}),
		  .siovref(tmpSIOVREF__Soil_Moisture_Vin_Pin_net),
		  .interrupt({tmpINTERRUPT_0__Soil_Moisture_Vin_Pin_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Soil_Moisture_Vin_Pin_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};


	cy_clock_v1_0
		#(.id("e4c1f497-2f70-4b00-b985-611a33cff988"),
		  .source_clock_id(""),
		  .divisor(0),
    ...
    Timer_v2_80_5 Data_Logging_Timer (
        .reset(Net_156),
        .interrupt(Net_164),
        .enable(1'b1),
        .trigger(1'b1),
        ...
        .tc(Net_162),
        .clock(Net_154));
    defparam Data_Logging_Timer.CaptureCount = 2;
    defparam Data_Logging_Timer.CaptureCounterEnabled = 0;
    defparam Data_Logging_Timer.DeviceFamily = "PSoC5";
    defparam Data_Logging_Timer.InterruptOnCapture = 0;
    defparam Data_Logging_Timer.InterruptOnTC = 1;
    defparam Data_Logging_Timer.Resolution = 32;
    defparam Data_Logging_Timer.SiliconRevision = "0";
