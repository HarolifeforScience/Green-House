...
#define Timer2_INIT_PERIOD             4499u
#define Timer2_INIT_CAPTURE_MODE       ((uint8)((uint8)1u << Timer2_CTRL_CAP_MODE_SHIFT))
...
***************************************/
    ...
    ***************************************/
    ...
    #define Timer2_CONTROL             (* (reg8 *) Timer2_TimerUDB_sCTRLReg_SyncCtl_ctrlreg__CONTROL_REG )
        ...
        #define Timer2_CAPTURE_LSB         (* (reg8 *) Timer2_TimerUDB_sT32_timerdp_u0__F0_REG )
        #define Timer2_CAPTURE_LSB_PTR       ((reg8 *) Timer2_TimerUDB_sT32_timerdp_u0__F0_REG )
        #define Timer2_PERIOD_LSB          (* (reg8 *) Timer2_TimerUDB_sT32_timerdp_u0__D0_REG )
        #define Timer2_PERIOD_LSB_PTR        ((reg8 *) Timer2_TimerUDB_sT32_timerdp_u0__D0_REG )
        #define Timer2_COUNTER_LSB         (* (reg8 *) Timer2_TimerUDB_sT32_timerdp_u0__A0_REG )
        #define Timer2_COUNTER_LSB_PTR       ((reg8 *) Timer2_TimerUDB_sT32_timerdp_u0__A0_REG )
    #elif(Timer2_Resolution <= 16u) /* 8-bit Timer */
        #if(CY_PSOC3) /* 8-bit addres space */
            #define Timer2_CAPTURE_LSB         (* (reg16 *) Timer2_TimerUDB_sT32_timerdp_u0__F0_REG )
            #define Timer2_CAPTURE_LSB_PTR       ((reg16 *) Timer2_TimerUDB_sT32_timerdp_u0__F0_REG )
            #define Timer2_PERIOD_LSB          (* (reg16 *) Timer2_TimerUDB_sT32_timerdp_u0__D0_REG )
            #define Timer2_PERIOD_LSB_PTR        ((reg16 *) Timer2_TimerUDB_sT32_timerdp_u0__D0_REG )
            #define Timer2_COUNTER_LSB         (* (reg16 *) Timer2_TimerUDB_sT32_timerdp_u0__A0_REG )
            #define Timer2_COUNTER_LSB_PTR       ((reg16 *) Timer2_TimerUDB_sT32_timerdp_u0__A0_REG )
        #else /* 16-bit address space */
            #define Timer2_CAPTURE_LSB         (* (reg16 *) Timer2_TimerUDB_sT32_timerdp_u0__16BIT_F0_REG )
            #define Timer2_CAPTURE_LSB_PTR       ((reg16 *) Timer2_TimerUDB_sT32_timerdp_u0__16BIT_F0_REG )
            #define Timer2_PERIOD_LSB          (* (reg16 *) Timer2_TimerUDB_sT32_timerdp_u0__16BIT_D0_REG )
            #define Timer2_PERIOD_LSB_PTR        ((reg16 *) Timer2_TimerUDB_sT32_timerdp_u0__16BIT_D0_REG )
            #define Timer2_COUNTER_LSB         (* (reg16 *) Timer2_TimerUDB_sT32_timerdp_u0__16BIT_A0_REG )
            #define Timer2_COUNTER_LSB_PTR       ((reg16 *) Timer2_TimerUDB_sT32_timerdp_u0__16BIT_A0_REG )
        #endif /* CY_PSOC3 */
    #elif(Timer2_Resolution <= 24u)/* 24-bit Timer */
        #define Timer2_CAPTURE_LSB         (* (reg32 *) Timer2_TimerUDB_sT32_timerdp_u0__F0_REG )
        #define Timer2_CAPTURE_LSB_PTR       ((reg32 *) Timer2_TimerUDB_sT32_timerdp_u0__F0_REG )
        #define Timer2_PERIOD_LSB          (* (reg32 *) Timer2_TimerUDB_sT32_timerdp_u0__D0_REG )
        #define Timer2_PERIOD_LSB_PTR        ((reg32 *) Timer2_TimerUDB_sT32_timerdp_u0__D0_REG )
        #define Timer2_COUNTER_LSB         (* (reg32 *) Timer2_TimerUDB_sT32_timerdp_u0__A0_REG )
        #define Timer2_COUNTER_LSB_PTR       ((reg32 *) Timer2_TimerUDB_sT32_timerdp_u0__A0_REG )
    #else /* 32-bit Timer */
            ...
            #define Timer2_CAPTURE_LSB         (* (reg32 *) Timer2_TimerUDB_sT32_timerdp_u0__32BIT_F0_REG )
            #define Timer2_CAPTURE_LSB_PTR       ((reg32 *) Timer2_TimerUDB_sT32_timerdp_u0__32BIT_F0_REG )
            #define Timer2_PERIOD_LSB          (* (reg32 *) Timer2_TimerUDB_sT32_timerdp_u0__32BIT_D0_REG )
            #define Timer2_PERIOD_LSB_PTR        ((reg32 *) Timer2_TimerUDB_sT32_timerdp_u0__32BIT_D0_REG )
            #define Timer2_COUNTER_LSB         (* (reg32 *) Timer2_TimerUDB_sT32_timerdp_u0__32BIT_A0_REG )
            #define Timer2_COUNTER_LSB_PTR       ((reg32 *) Timer2_TimerUDB_sT32_timerdp_u0__32BIT_A0_REG )
        #endif /* CY_PSOC3 || CY_PSOC5 */ 
    #endif

    #define Timer2_COUNTER_LSB_PTR_8BIT       ((reg8 *) Timer2_TimerUDB_sT32_timerdp_u0__A0_REG )
