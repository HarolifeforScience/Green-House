...
#if !(CY_PSOC5A &&\
	 Servo_motor__PORT == 15 && ((Servo_motor__MASK & 0xC0) != 0))
...
void    Servo_motor_SetInterruptMode(uint16 position, uint16 mode);
...
*/
     ...
     * \brief Constants to be passed as "mode" parameter in the Servo_motor_SetDriveMode() function.
     *  @{
     */
...
/* Interrupt constants */
#if defined(Servo_motor__INTSTAT)
/**
* \addtogroup group_constants
* @{
*/
    /** \addtogroup intrMode Interrupt constants
     * \brief Constants to be passed as "mode" parameter in Servo_motor_SetInterruptMode() function.
     *  @{
     */
        #define Servo_motor_INTR_NONE      (uint16)(0x0000u)
        #define Servo_motor_INTR_RISING    (uint16)(0x0001u)
        #define Servo_motor_INTR_FALLING   (uint16)(0x0002u)
        #define Servo_motor_INTR_BOTH      (uint16)(0x0003u) 
    /** @} intrMode */
/** @} group_constants */

    #define Servo_motor_INTR_MASK      (0x01u) 
#endif /* (Servo_motor__INTSTAT) */
...
/* SIO registers */
#if defined(Servo_motor__SIO_CFG)
    #define Servo_motor_SIO_HYST_EN        (* (reg8 *) Servo_motor__SIO_HYST_EN)
    #define Servo_motor_SIO_REG_HIFREQ     (* (reg8 *) Servo_motor__SIO_REG_HIFREQ)
    #define Servo_motor_SIO_CFG            (* (reg8 *) Servo_motor__SIO_CFG)
    #define Servo_motor_SIO_DIFF           (* (reg8 *) Servo_motor__SIO_DIFF)
#endif /* (Servo_motor__SIO_CFG) */
...
/* Interrupt Registers */
	...
	#define Servo_motor_0_INTTYPE_REG 		(* (reg8 *) Servo_motor__0__INTTYPE)
#endif /* (Servo_motor__INTSTAT) */

#endif /* CY_PSOC5A... */

#endif /*  CY_PINS_Servo_motor_H */
